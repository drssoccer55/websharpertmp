...
{
 "use strict";
 var Global,websharpertmp,Client,WebSharper,Obj,UI,Var$1,TestJsModule,Operators,Templating,Runtime,Server,TemplateInstance,Arrays,ProviderBuilder,ListModel,Unchecked,websharpertmp_Templates,Handler,Var,ConcreteVar,Snap,SC$1,System,Guid,Collections,List,Client$1,Templates,Doc,JavaScript,Pervasives,Abbrev,Fresh,Dictionary,View,Object,AttrProxy,CheckedInput,Numeric,HashSet,Seq,TemplateInitializer,EventTarget,Node,JS,DictionaryUtil,Enumerator,T,SC$2,WindowOrWorkerGlobalScope,Docs,SC$3,Storage,DocElemNode,CharacterData,Elt,Prepare,Slice,DomUtility,KeyCollection,An,Settings,Mailbox,ArrayStorage,Attrs,Dyn,Array,Attrs$1,AttrModule,List$1,T$1,Strings,Updates,ValueCollection,Docs$1,RunState,NodeSet,Concurrency,Anims,SC$4,HashSetUtil,BindVar,SC$5,SC$6,AppendList,SC$7,DynamicAttrNode,Scheduler,Easing,AsyncBody,SC$8,CT,HashSet$1,String,CancellationTokenSource,DomNodes,Queue,Char,Error,OperationCanceledException,Lazy,SC$9,LazyExtensionsProxy,LazyRecord,IntelliFactory,Runtime$1,console,Math,Date;
 Global=self;
 websharpertmp=Global.websharpertmp=Global.websharpertmp||{};
 Client=websharpertmp.Client=websharpertmp.Client||{};
 WebSharper=Global.WebSharper=Global.WebSharper||{};
 Obj=WebSharper.Obj=WebSharper.Obj||{};
 UI=WebSharper.UI=WebSharper.UI||{};
 Var$1=UI.Var$1=UI.Var$1||{};
 TestJsModule=Client.TestJsModule=Client.TestJsModule||{};
 ...
 websharpertmp_Templates=Global.websharpertmp_Templates=Global.websharpertmp_Templates||{};
 Handler=Server.Handler=Server.Handler||{};
 Var=UI.Var=UI.Var||{};
 ConcreteVar=UI.ConcreteVar=UI.ConcreteVar||{};
 Snap=UI.Snap=UI.Snap||{};
 SC$1=Global.StartupCode$websharpertmp$Client=Global.StartupCode$websharpertmp$Client||{};
 ...
 Client.Main=function()
 {
  ...
  a=(b=(t=(_this=(L=Doc.Convert(function(name)
  {
   ...
   return(b$1=(_this$2=new ProviderBuilder.New$1(),(_this$2.h.push({
    ...
    $0:"name",
    $1:name
   }),_this$2)),(p$1=Handler.CompleteHoles(b$1.k,b$1.h,[]),(i$1=new TemplateInstance.New(p$1[1],websharpertmp_Templates.listitem(p$1[0])),b$1.i=i$1,i$1))).get_Doc();
  ...
  },function()
  {
   ...
   newName.Set("");
  })),t)),(p=Handler.CompleteHoles(b.k,b.h,[["name",0]]),(i=new TemplateInstance.New(p[1],websharpertmp_Templates.main(p[0])),b.i=i,i))).get_Doc();
 ...
 websharpertmp_Templates.listitem=function(h)
 {
 ...
 websharpertmp_Templates.main=function(h)
 {
  Templates.LoadLocalTemplates("index");
  return h?Templates.NamedTemplate("index",{
   $:1,
...
//# sourceMappingURL=websharpertmp.map
